...
PImage weapon_red_gem_sword;
PImage weapon_big_hammer;
PImage weapon_hammer;
PImage weapon_baton_with_spikes;
PImage weapon_mace;
PImage weapon_katana;
PImage weapon_saw_sword;
PImage weapon_anime_sword;
PImage weapon_axe;
PImage weapon_machete;
PImage weapon_cleaver;
PImage weapon_duel_sword;
PImage weapon_knight_sword;
PImage weapon_golden_sword;
